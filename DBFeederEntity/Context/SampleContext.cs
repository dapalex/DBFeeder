...
namespace DBFeederEntity.Context
{
    ...
    public partial class SampleContext : DBFeederContext
    {
        ...
        private void TableBMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TableB>().Property(x => x.Column_Y).HasColumnName(@"Column_Y").IsRequired().ValueGeneratedNever().HasMaxLength(600);
            modelBuilder.Entity<TableB>().HasKey(@"ID");
        }
